package com.rubber.project.users.service;
...
import com.rubber.project.users.dao.UsersDao;
import com.rubber.project.users.dto.UsersDto;
...
public class UsersServiceImpl implements UsersService {
	...
	public void deleteUser(HttpSession session, ModelAndView mView) {
		...
		// 로그아웃 처리
		session.removeAttribute("id");
		// ModelAndView 객체에 탈퇴한 회원의 아이디를 담아둔다.
		mView.addObject("id", id);
	}

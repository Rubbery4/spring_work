...
public class FortuneController {
	...
	public String fortune (HttpServletRequest request) {
		...
		request.setAttribute("Today", fortuneToday);
	...
	public ModelAndView fortune2 () {
		...
		// 모델과 view page 정보가 모두 담겨 있는 ModelAndView 객체에 리턴해주면 똑같이 동작한다.
		return mView;
	}
	// ModelAndView 를 매개변수로 선언하면 스프링 프레임워크가 알아서 객체 생성후 참조값을 넣어준다.
